...
function Info(){
  return <div>
   ...
   <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae, dicta sed quisquam provident at commodi omnis quia fugit, mollitia veritatis ipsa, quo aliquid facere dignissimos?</p>
  </div>
}
function skills(){
  return <div>
